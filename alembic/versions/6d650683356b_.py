...
Revision ID: 6d650683356b
Revises: 
Create Date: 2025-06-10 18:13:16.226944
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('article', 'marketplace', 'user_id', name='unique_article_marketplace_user_id'),
    sa.UniqueConstraint('id')
    )
